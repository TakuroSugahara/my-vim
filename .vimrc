...
nnoremap <S-U> :<C-u>Unite buffer<CR>
...
highlight GitGutterChange ctermfg=white ctermbg=black
highlight GitGutterChangeDelete ctermfg=white ctermbg=black
" ,gg で左側の表示非表示を行う, ,ghで変更があったコードをハイライトする
